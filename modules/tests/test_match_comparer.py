...
class CompareConfirmationTest(TestCase):
    ...
    def test_enemy_accepted_suggestion(self):
        ...
        md = create_temporary_match_data(team=self.team, enemy_team=self.enemy_team,
                                         begin=string_to_datetime("2022-01-01 17:00"),
                                         latest_confirmation_log=LogSchedulingConfirmation(timestamp="1642948400",
                                                                                           user_id=1,
    ...
    def test_auto_confirmation(self):
        ...
        md = create_temporary_match_data(team=self.team, enemy_team=self.enemy_team,
                                         begin=string_to_datetime("2022-01-01 17:00"),
                                         latest_confirmation_log=LogSchedulingAutoConfirmation(timestamp="1642948400",
                                                                                               user_id=1,
                                                                                               details="Sun, 03 Oct 2021 15:00:00 +0200")
                                         )
        cp = MatchComparer(match_old=match, match_new=md)
...
def create_temporary_match_data(match_id=1, match_day=1, team=None, enemy_team=None, closed=False,
                                ...
                                latest_confirmation_log=None, enemy_lineup=None):
